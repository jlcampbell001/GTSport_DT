...
{
    /// <summary>Validations to save or delete an owner entity.</summary>
    public class OwnerValidation : Validation<Owner>
    {
        private OwnersRepository ownersRepository;

        /// <summary>Initializes a new instance of the <see cref="OwnerValidation"/> class.</summary>
        ...
        /// <summary>Validations to delete an owner for the passed primary key.</summary>
        /// <param name="primaryKey">The primary key related to the owner to delete.</param>
        /// <exception cref="OwnerNotFoundException">
        /// The owner must exist before it can be deleted.
        /// </exception>
        ...
        /// <summary>Validations to save the passed owner entity.</summary>
        ...
        /// <exception cref="OwnerNameAlreadyExistsException">
        /// The owner name can not already exist when saving an owner for a different primary key.
        /// </exception>
